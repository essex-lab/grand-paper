...
This script runs 25 ns of NPT MD on a box of pure water, in order to see the density
...
for f in range(system.getNumForces()):
    ...
    if 'NonbondedForce' == force.__class__.__name__:
        ...
        # Also need to switch off the long-range LJ, as this isn't used in GCMD
...
# Add a reporter - write out every 0.1 ns
simulation.reporters.append(StateDataReporter(stdout, 50000, step=True, time=True, potentialEnergy=True,
